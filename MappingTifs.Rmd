...
rastlistLST <- list.files(path = "~/Desktop/WMA/MappingClimateVariables/LST", pattern='.tif$', all.files=TRUE, full.names=T)
StackLST<-stack(rastlistLST)

rastlistNDVI <- list.files(path = "~/Desktop/WMA/MappingClimateVariables/NDVI", pattern='.tif$', all.files=TRUE, full.names=T)
StackNDVI<-stack(rastlistNDVI)

rastlistPrecip <- list.files(path = "~/Desktop/WMA/MappingClimateVariables/Precip", pattern='.tif$', all.files=TRUE, full.names=T)
StackPrecip<-stack(rastlistPrecip)

rastlistSoil <- list.files(path = "~/Desktop/WMA/MappingClimateVariables/Soil", pattern='.tif$', all.files=TRUE, full.names=T)
